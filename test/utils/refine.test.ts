...
describe("refine", function() {
  ...
  describe("initial rule", function() {
    ...
    it("should be called", function() {
      ...
      Sinon.assert.calledOnceWithExactly(this.validRule, [], "chunkylover53@aol.com", this.ctx);
    });
  ...
  describe("custom rule", function() {
    ...
    it("should be called", function() {
      ...
      Sinon.assert.calledOnceWithExactly(refineCb, "chunkylover53@aol.com", this.ctx);
    });
