import type from "/-/type-detect@v4.0.8-3tmjjwwFw2jHiLYy7SbM/dist=es2019,mode=imports/optimized/type-detect.js";
/*!
 * deep-eql
...
export {MemoizeMap_1 as MemoizeMap, deepEql as __moduleExports};
